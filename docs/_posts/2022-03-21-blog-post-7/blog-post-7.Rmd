...
plot(comm.lab,wars_in_1000s.ig)
...
plot(wars_in_1000s.wt, wars_in_1000s.ig)

```

```{r}
countries <- row.names(total_1000s)
```
...
View(total_1000s_brokerag_reg_binom)
